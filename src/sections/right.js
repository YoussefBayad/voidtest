...
import satisfaction from "assets/images/200.png";
...
const data = {
  ...
  description: (
    <div>
      Si vous n'avez pas encore entendu parler du #DrapeauMéningites, regardez
      la vidéo de Vaskange et découvrez la signification de chaque couleur.
    </div>
  ),
};
