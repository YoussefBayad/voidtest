...
const data = [
  {
    ...
    imgSrc: five,
    altText:
      "MSolution for intelligent management, filing and archiving of your documents and enterprise contracts.",
    title: "EDM",
  },
  {
    id: 2,
    imgSrc: six,
    altText:
      "Exchange your mail differently with RESOPOSTE, a solution for dematerializing postal mail.",
    title: "RESOPOSTE",
  },
  {
    id: 3,
    imgSrc: seven,
    altText: "Automatically secure all your data!",
    title: "DATA BACKUP",
  },
  {
    id: 4,
    imgSrc: eight,
    altText:
      "Geolocation solution for your company vehicles, aimed at optimizing your journeys.",
