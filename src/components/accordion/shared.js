...
export const AccordionButton = ({ children, small, ...rest }) => (
  <div sx={small ? styles.buttonToggleSmall : styles.buttonToggle} {...rest}>
    {children}
  </div>
);
...
export const AccordionItemPackage = ({ isOpen, children, ...rest }) => (
  <div
    css={{
      overflow: "hidden",
      padding: "10px 0",
